...
def nalog():
    ...
    if not more5:
        ...
        if more3 & living:
            sole_home = st.checkbox('Продажа единственного жилья', False, None, 'По общему правилу под единственным жильем понимается жилое помещение, которое является для гражданина и членов его семьи единственным пригодным для постоянного проживания')
